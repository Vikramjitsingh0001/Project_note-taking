...
def butt():                                                                                      #def button function
    b = Button(frame5, text='Update', bg='blue', fg='orange', command=Up).grid(row=4,column=2)   #update button pack

    c = Button(frame5, text='Delete', bg='blue', fg='orange', command=dele).grid(row=5,column=2) #delete button pack

    d = Button(frame5, text='Read', bg='blue', fg='orange', command=redd).grid(row=6,column=2)   #read button pack

    e=Button(frame5, text='Sort', bg='blue', fg='orange', command=sot).grid(row=3,column=2)      #sort button pack
